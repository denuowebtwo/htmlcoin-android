...
public class ParameterViewHolder extends RecyclerView.ViewHolder {
    ...
    public ParameterViewHolder(View itemView) {
        ...
        etParam.setTypeface(FontManager.getInstance().getFont(etParam.getContext().getString(R.string.fontRegular)));
    ...
    public void bind(ContractMethodParameter parameter, boolean isLast) {
        ...
        etParam.setHint(fromCamelCase(parameter.getName())+" ("+parameter.getType()+")");
    ...
    private String validateAddress(String content){
        Pattern pattern = Pattern.compile("^[qQhH][a-km-zA-HJ-NP-Z1-9]{0,33}$");
